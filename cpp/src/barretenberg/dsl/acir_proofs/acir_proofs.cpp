...
extern "C"
{
    ...
    const char *acir_get_circuit_sizes(uint8_t const *acir_vec, uint32_t *exact, uint32_t *total, uint32_t *subgroup)
    {
        try
        {
    ...
    const char *acir_init_proving_key(in_ptr acir_composer_ptr, uint8_t const *acir_vec)
    {
        try
        {
